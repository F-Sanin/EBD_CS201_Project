...
plt.scatter(buy_signal.index,buy_signal["SMA_short"], marker="^", color="green", label="Buy")
plt.scatter(sell_signal.index, sell_signal["SMA_short"], marker="v", color="red", label="Sell")
